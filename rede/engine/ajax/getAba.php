...
?>
	...
	<div class="modal-body">
		<div class="row">
			...
			<div class="col-md-8">
				<b>Data de Nascimento: </b><?php echo $perfilrsql['data_nasc']; ?><br>
				<b>Telefone: </b><?php echo $perfilrsql['telefone']; ?><br>
				<b>Telefone2: </b><?php echo $perfilrsql['telefone2']; ?><br>
				<b>Cidade: </b><?php echo $perfilrsql['cidade']; ?><br>
				<b>Estado: </b><?php echo $perfilrsql['estado']; ?><br>
				<b>Regiao: </b><?php echo $perfilrsql['regiao']; ?><br>
				<b>País: </b><?php echo $perfilrsql['pais']; ?><br>
				<b>Descricao: </b><?php echo $perfilrsql['descricao1']; ?><br>
			</div>
		</div>
	</div>
